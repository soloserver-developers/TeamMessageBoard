...
import page.nafuchoco.teammessageboard.TeamMessageBoard;
...
public abstract class DatabaseTable {
    private static final String PREFIX = TeamMessageBoard.getPluginConfig().getInitConfig().getTablePrefix();
